...
import { escapeHtml, fmtDate, timeAgo, markdown, emptyState, toast, onAction, openModal, confirmDialog, flashFocused, loadingState, } from './ui.js?v=c10f314afe';
import { aiAvailable, currentParams } from './app.js?v=c10f314afe';
let staleDays = 60;
let cache = [];
