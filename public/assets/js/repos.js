...
import { escapeHtml, fmtDate, timeAgo, markdown, emptyState, toast, onAction, openModal, confirmDialog, flashFocused, loadingState, } from './ui.js?v=e4ef27a132';
import { aiAvailable, currentParams } from './app.js?v=e4ef27a132';
let staleDays = 60;
let cache = [];
