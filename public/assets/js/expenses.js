...
import { escapeHtml, money, fmtDate, monthStr, todayStr, emptyState, toast, onAction, openModal, formValues, confirmDialog, } from './ui.js';
...
export async function renderExpenses(container) {
    ...
    const monthEl = container.querySelector('[data-role="month"]');
...
async function loadCharts(container) {
    ...
    const c = await apiGet('stats', 'expenses', { month });
    host.innerHTML = `
